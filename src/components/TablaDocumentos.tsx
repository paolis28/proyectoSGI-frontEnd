...
const TablaDocumentos: React.FC = () => {
  const [documentos] = useState<Documento[]>([
    { id: 1, nombre: 'Documento 1', tipo: 'Tipo 1', categoria: 'Categoria 1', fechaModificacion: '2024-03-28' },
    { id: 2, nombre: 'Documento 2', tipo: 'Tipo 2', categoria: 'Categoria 2', fechaModificacion: '2024-03-29' },
  ]);
